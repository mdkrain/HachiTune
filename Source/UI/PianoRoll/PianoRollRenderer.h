...
public:
    ...
    void drawNotes(juce::Graphics& g, double visibleStartTime, double visibleEndTime);
...
private:
    ...
    void drawNoteWaveform(juce::Graphics& g, const Note& note, float x, float y, float w, float h,
